    ...
    render() {
        ...
        <div>
            ...
            <body className="container">
                ...
                be working with the Github REST API. This is a GUI React project primarily written in JavaScript. The requirements for this project are 
                to do the following:
            </body>
            <body className ="container">
            ...
            2. Find an Organization by name and return the following:<br/>
                -A list of all public members. For each member the list must include: Username / Actual Name / email(if available)<br/>
            <br/>
            ...
            <br/>
            For a video demonstration of this app look here: https://youtu.be/N2fsf3XkV8g<br/>
            <br/>
